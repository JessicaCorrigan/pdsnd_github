...
def get_filters():
    ...
    city = user_input("Please select a city from the following to analyze: Chicago, New York, Washington: ", CITIES)
    month = user_input("Please enter the name of the month you would like to filter by (Ex: january, february, ..june) or enter \'all\' to view unfilterd data:  ", MONTHS)
